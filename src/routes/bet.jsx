...
const [showPopup, setShowPopup] = useState(false);
  ...
  <div 
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="flex flex-row items-center gap-3" data-testid="1529:257">
      
      {/* Borrow Button */}
      <div
        className={`flex flex-row w-28 h-9 justify-center items-center gap-2 rounded border ${
          activeTab === 'borrow' ? 'bg-emerald-950 border-emerald-400' : 'border-emerald-800/40'
        } cursor-pointer`}
      ...
      >
        <span
          className={`text-center text-sm capitalize ${
            activeTab === 'borrow' ? 'text-[#25D0AB]' : 'text-emerald-400/50'
          }`}
          style={{ fontFamily: 'Amina, sans-serif' }}
      ...
      >
        <div
          className={`flex flex-row h-9 justify-center items-center gap-2 w-full rounded cursor-pointer ${
            activeTab === 'lend' ? 'bg-emerald-950' : 'border border-emerald-800/40'
          }`}
        ...
        >
          <span
            className={`text-center text-sm capitalize ${
              activeTab === 'lend' ? 'text-[#25D0AB]' : 'text-emerald-400/50'
            }`}
            style={{ fontFamily: 'Amina, sans-serif' }}
          ...
          >
            Lend
                       ...
                       <div 
        className="pt-[22px] pb-[22px] flex flex-col items-start gap-[10px] self-stretch"
        data-testid="1533:44"
      >
